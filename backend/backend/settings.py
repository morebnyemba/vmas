...
SECRET_KEY = env("SECRET_KEY", default="django-insecure-pa&t9y8_gsj#eh_(eusc-x#-83vk(5wx=_-e7ixk$&rsmgu@wn")
...
STATIC_URL = 'static/'
STATIC_ROOT = os.path.join(BASE_DIR, 'staticfiles') # This should map to /app/staticfiles in the container
MEDIA_URL = "/media/"
...
CSRF_TRUSTED_ORIGINS = env.list("CSRF_TRUSTED_ORIGINS", default=[
    "https://e42cd5b6-8639-41f7-8d5f-17454899a006.e1-us-east-azure.choreoapps.dev",
])
EMAIL_BACKEND = 'django.core.mail.backends.filebased.EmailBackend'
EMAIL_FILE_PATH = BASE_DIR / 'sent_emails'
DEFAULT_FROM_EMAIL = 'noreply@visitmasvingo.com'
...
JAZZMIN_SETTINGS = {
    ...
    "site_title": "Visit Masvingo Admin",

    # Title on the login screen (19 chars max) (defaults to current_admin_site.site_header if absent or None)
    "site_header": "Visit Masvingo",

    # Title on the brand (19 chars max) (defaults to current_admin_site.site_header if absent or None)
    "site_brand": "Visit Masvingo",
